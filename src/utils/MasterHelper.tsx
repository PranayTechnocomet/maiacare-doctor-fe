...
//   const authPages = ["/loginpage", "/register","/forgotppassword","/resetpassword","/verificationcode","/selectprofile","/selectclinic" ];
...
function MasterHelper({ children }: MasterProps) {
  const [collapsed, setCollapsed] = useState(true);
const authPages = ["/login", "/register", "/forgotppassword","/resetpassword","/verification","/selectprofile","/selectclinic"];
  const pathName = usePathname();
