                                    ...
                                    <Dropdown align="end" className="d-flex align-items-center">
                                        ...
                                        <Dropdown.Menu className="dots-open">
                                            <Dropdown.Item className="no-hover">
                                                <div className="d-flex align-items-center gap-2" onClick={() => { setEditTreatmentModel(true) }}>
                                                    ...
                                                    <span className="settings-accordion-subtitle m-0">Edit</span>
                                                </div>
                                            </Dropdown.Item>
                                            <Dropdown.Item className="no-hover">
                                                <div className="d-flex align-items-center gap-2 ">
                                                    ...
                                                    <span className="appoiment-dots-open-danger m-0">Terminate</span>
                                                </div>
                                            </Dropdown.Item>
                                        </Dropdown.Menu>
                                    </Dropdown>
                                ...
                                <div className="progressUpdates-border-box mt-3">
                                    ...
                                    {isFertilityDataEmpty(treatmentFertilityAssessmentData) ? (
                                        ...
                                        <Row className="g-3 mt-2">
                                            <Col md={6}>
                                                <p className="patient-treatment-box-subtitle mb-2">Patient</p>
                                                <Accordion>
                                                    <Accordion.Item eventKey="0" className='phisical-assessment-accordion-item mb-2' >
                                                        <Accordion.Header >
                                                            <div className='d-flex justify-content-center align-items-center gap-2'>
                                                    ...
                                                    <Accordion.Item eventKey="1" className='phisical-assessment-accordion-item mb-2'>
                                                        <Accordion.Header>
                                                            <div className='d-flex justify-content-center align-items-center gap-2'>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 35 35" fill="none">
                                            ...
                                            <Col md={6}>
                                                <p className="patient-treatment-box-subtitle mb-2">Partner</p>
                                                ...
                                                {medicationPrescriptionwithProgress?.map((item, index) => {
                                                    ...
                                                    return (
                                                        <Col md={6} key={item.id}>
                                                            <Accordion.Item eventKey={index.toString()} className='medication-prescription-accordion-item-main mb-3'>
