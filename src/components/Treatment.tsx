    ...
    return (
        <>
            ...
            <Modal
                            ...
                            <div>
                                ...
                                <div className="d-flex align-items-center gap-1">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <span className="patient-calendar-modal-subtitle">+91 12345 67890</span>
                                    </div>
                                    <div className="d-flex align-items-center gap-1">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <span className="patient-calendar-modal-subtitle">riya@gmail.com</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                closeButton={true}
            >
                <PatientCalenderForm setPatientCalendarModel={setPatientCalendarModel} />
            </Modal>
