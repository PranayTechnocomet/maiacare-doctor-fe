...
import Clinic from "../assets/images/Profile_Clinic.png";
      ...
      <Row className='min-vh-100'>
        ...
        <Col md={6} className="d-flex align-items-center justify-content-center">
          <div>
            ...
            <h2 className="login-title text-center mt-3">Select Profile.</h2>
            <p className="login-subtitle text-center">
              Select account you want to sign in
            </p>

            <div className='d-flex flex-column align-items-center select-profile-main'>
              {profileData.map((profile) => (
                <div key={profile.id} className='profile-card d-flex justify-content-between align-items-center my-2 w-100'>
                ...
                <div className='d-flex gap-3 align-items-center'>
                  ...
                  <div>
                    ...
                    <p className='select-profile-subtitle'>{profile.subtitle}</p>
                  </div>
                </div>
