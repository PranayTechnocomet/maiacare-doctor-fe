...
function TreatmentPlan({
...
}:
    {
        ...
        setTreatmentDetailsTempShow: React.Dispatch<React.SetStateAction<boolean>>
    }) {
    ...
    const [TreatmentShowHideData, setTreatmentShowHideData] = useState<boolean>(false);
        ...
        <>
            ...
            {step == 2 && (
                ...
                <>
                    ...
                    {medicalPrescription.length > 0 && TreatmentShowHideData == false && (
                        <>
                                    ...
                                    return (
                                        <Accordion.Item eventKey={index.toString()} className='medication-prescription-accordion-item-main mb-3' key={index}>
                                            ...
                                            <Accordion.Body className='pt-0'>
                                                ...
                                                <Button className='mt-3' variant="outline" disabled={false} contentSize="small" onClick={() => { setEditForm(item); setShowEditFormShowModel(true); setTreatmentPlanModel(false) }}>
                    ...
                    <MedicationPrescriptionForm setMedicalPrescription={setMedicalPrescription} setStep={setStep} setStepper={setStepper} setShowEditFormShowModel={setShowEditFormShowModel} medicalPrescription={medicalPrescription} />
                    ...
                    <Modal
                        ...
                        closeButton={true}
                    >
                        <MedicationPrescriptionForm editForm={editForm} setMedicalPrescription={setMedicalPrescription} setShowEditFormShowModel={setShowEditFormShowModel} medicalPrescription={medicalPrescription} TreatmentShowHideData={TreatmentShowHideData} setTreatmentShowHideData={setTreatmentShowHideData} />
                    </Modal>
