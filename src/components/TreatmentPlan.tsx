...
function TreatmentPlan({ setTreatmentPlanModel }:
    { setTreatmentPlanModel: React.Dispatch<React.SetStateAction<boolean>> }) {

    const [step, setStep] = useState<number>(1);
    const [stepper, setStepper] = useState(1);
    const totalSteps = 3;
    const [showEditFormShow, setShowEditFormShow] = useState<boolean>(false);
        ...
        <>
            ...
            {step == 2 && (
                ...
                <>
                    ...
                    {showEditFormShow ? (
                        <MedicationPrescriptionForm setMedicalPrescription={setMedicalPrescription} setStep={setStep} setStepper={setStepper} step={step} stepper={stepper} editForm={editForm} setShowEditFormShow={setShowEditFormShow} />
                    )
                        :
                        <div>
                                            ...
                                            return (
                                                <Accordion.Item eventKey={index.toString()} className='medication-prescription-accordion-item-main mb-3' key={index}>
                                                    ...
                                                    <Accordion.Body className='pt-0'>
                                                        ...
                                                        <Button className='mt-3' variant="outline" disabled={false} contentSize="small" onClick={() => { setEditForm(item); setShowEditFormShow(true) }}>
                            ...
                            <MedicationPrescriptionForm setShowEditFormShow={setShowEditFormShow} setMedicalPrescription={setMedicalPrescription} setStep={setStep} setStepper={setStepper} step={step} stepper={stepper} />
                        </div>
                    }
            ...
            {step == 3 && (
                <>
                    <FollowUpActionForm setStep={setStep} setStepper={setStepper} step={step} stepper={stepper} setTreatmentPlanModel={setTreatmentPlanModel} />
                </>
            )}
