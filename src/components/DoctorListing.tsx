                  ...
                  <Modal
                    ...
                    header={
                      <div className='d-flex gap-3'>
                        <p className="doctor-listing-modal-label"># Appointment Id <span className='doctor-listing-modal-id'>1234</span></p>
                    ...
                    <>
                      <div>
                        ...
                        <div className='doctor-listing-modal-profile'>
                          <div className='d-flex justify-content-between'>
                            <div className='d-flex gap-2' >
                              <Image src={PriyaGupta} alt="doctor" className='doctor-listing-modal-profile-img' width={46} height={46} />
                              <div className='d-flex flex-column gap-2'>
                                <div className='d-flex gap-4'>
                                  <p className='doctor-listing-modal-profile-title m-0'>Priya Gupta</p>
                                  <p className='doctor-listing-modal-profile-subtitle m-0'>Foollw Up</p>
                                </div>
                                <div className='d-flex gap-4'>
                  ...
                  <div>
                    <div className='docotor-listing-today-schedule-datas'>
                      <Card className="d-flex flex-row align-items-center p-2 shadow-sm rounded-3 border-0" style={{ maxWidth: "350px" }}>
                        {/* Profile Image */}
                        <Image src={PriyaGupta} alt="Profile"  width={50} height={50} className="me-2 rounded-circle" />

                        {/* User Info */}
                        <div className="flex-grow-1">
                          <p className="doctor-listing-modal-patient-name m-0">Ananya Sharma</p>
                          <div className="d-flex align-items-center doctor-listing-modal-label " >
                            <BsClock className=" " /> 11:00 AM
                          </div>
                        </div>

                        {/* Button */}
                        <Button variant="default" className="doctor-listing-modal-button" onClick={() => setDoctorListingModal(true)}>
                          Check-In
                        </Button>
                      </Card>
                    </div>
