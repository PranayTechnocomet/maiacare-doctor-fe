                ...
                <Row className='mt-4 g-4'>
                    <Col md="5">
                        <div className='faqs-secation'>
                            ...
                            <p className='support-faqs-desc pe-lg-5 pe-0'>Everything you need to know about the software and billing. Cant find answers you’re looking for? Please contact us on the phone number or on our email.</p>
                        ...
                        <Accordion defaultActiveKey="0">
                            ...
                            <Accordion.Item eventKey="0">
                                ...
                                <Accordion.Body className='support-accordion-content p-0'>
                                    Everything you need to know about the software and billing. Cant find answers you’re looking for? Please contact us on the phone number.
                                </Accordion.Body>
                            </Accordion.Item>
