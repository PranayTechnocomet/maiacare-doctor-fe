      ...
      <div className='d-flex justify-content-between align-items-start  '>
        <div className='d-flex align-items-start align-items-sm-center gap-3 flex-column flex-sm-row'>
          ...
          <div>
            ...
            <div className='pt-sm-1 p-0 d-flex  '>
              <div className='me-2 doctor-profile-subheading'><svg width="14" className='me-1' height="16" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {id}</div>
              <div className='doctor-profile-subheading'><svg className='me-1' width="14" height="16" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='pt-sm-1 p-0 d-flex '>
              <div className='me-2 doctor-profile-subheading'><svg className='me-1' width="14" height="17" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {dob}</div>
              <div className='doctor-profile-subheading'><svg className='me-1' width="14" height="16" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="pt-sm-1 p-0 doctor-profile-subheading">
              <svg className='me-1' width="14" height="16" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
