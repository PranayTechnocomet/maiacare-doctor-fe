                                    ...
                                    <div>
                                        ...
                                        <div className='pt-sm-2 p-0 d-flex gap-2 '>
                                            ...
                                            <div className='doctor-profile-subheading'><svg width="21" height="21" viewBox="0 0 25 25" className='me-1' fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M3.39966 5.57422H21.3997V18.3242C21.3997 18.5231 21.3206 18.7139 21.18 18.8545C21.0393 18.9952 20.8486 19.0742 20.6497 19.0742H4.14966C3.95075 19.0742 3.75998 18.9952 3.61933 18.8545C3.47868 18.7139 3.39966 18.5231 3.39966 18.3242V5.57422Z" stroke="#8A8D93" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M21.3997 5.57422L12.3997 13.8242L3.39966 5.57422" stroke="#8A8D93" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
