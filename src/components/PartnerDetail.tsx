                                            ...
                                            <Row className='g-3'>
                                                <Col xl={6} lg={12} md={12} sm={6}>
                                                    <div className='phisical-assessment-accordion-showData-box d-flex gap-2'>
                                                        <Image src={hiegthImg} alt="Age" width={40} height={40} />
                                                ...
                                                <Col xl={6} lg={12} md={12} sm={6}>
                                                    <div className='phisical-assessment-accordion-showData-box d-flex gap-2'>
                                                        <Image src={weightImg} alt="Age" width={40} height={40} />
                                                        <div className='d-flex flex-column gap-1'>
                                                ...
                                                <Col xl={6} lg={12} md={12} sm={6}>
                                                    <div className='phisical-assessment-accordion-showData-box d-flex gap-2'>
                                                        <Image src={BMIIMG} alt="Age" width={40} height={40} />
                                                        <div className='d-flex flex-column gap-1'>
                                                ...
                                                <Col xl={6} lg={12} md={12} sm={6}>
                                                    <div className='phisical-assessment-accordion-showData-box d-flex gap-2'>
                                                        <Image src={BloodGroup} alt="Age" width={40} height={40} />
                                                        <div className='d-flex flex-column gap-1'>
                                                ...
                                                <Col xl={6} lg={12} md={12} sm={6}>
                                                    <div className='phisical-assessment-accordion-showData-box d-flex gap-2'>
                                                        <Image src={BloodPressure} alt="Age" width={40} height={40} />
                                                        <div className='d-flex flex-column gap-1'>
                                                ...
                                                <Col xl={6} lg={12} md={12} sm={6}>
                                                    <div className='phisical-assessment-accordion-showData-box d-flex gap-2'>
                                                        <Image src={HeartRate} alt="Age" width={40} height={40} />
                                                        <div className='d-flex flex-column gap-1'>
