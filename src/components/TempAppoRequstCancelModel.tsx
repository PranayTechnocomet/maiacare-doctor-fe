...
export function AppointmentRequestCancelModel({setDoctorListingModal , RescheduleModal , setRescheduleModal , CancelModal , setCancelModal }: RescheduleAppointmentProps ) {
