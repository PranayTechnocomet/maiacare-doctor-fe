...
import { PatientReportType } from "@/utils/types/interfaces"
                            ...
                            {patientReport.length > 0 ?
                                ...
                                <>
                                    <div className='d-flex justify-content-between align-items-center mb-4'>
                                        <h6 className='accordion-title m-0'>Reports</h6>
                                        <Button variant="outline" disabled={false} className='addnew-btn' contentSize="small" onClick={handleOpenModal} >
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    ...
                                    {patientReport.map((item, index) => {
                                        return (
                                            <div className='d-flex justify-content-between align-items-center report-box mb-3' key={index}>
                                                <div className='d-flex gap-2'>
                                                    <Image
                                                        src={
                                                    ...
                                                    <div className='d-flex flex-column'>
                                                        <span className='patient-treatment-box-subtitle-desc mb-1'>{item.name}</span>
                                ...
                                <>
                                    ...
                                    <div className='text-center mt-4'>
                                        ...
                                        <Button variant="outline" disabled={false} onClick={handleOpenModal} >
                                            <div className='d-flex justify-content-center align-items-center gap-2 '>
