            ...
            <Row className="mt-3 g-3">
                ...
                <Col lg={6}>
                    <ContentContainer>
                        ...
                        <p className="appointment-details-invoice-header">Appointment Details</p>

                        <Row className="g-3">
                            <Col sm={4} className="col-6">
                                <p className="appointment-details-invoice-title m-0 mb-1">Patient ID</p>
                                <p className="appointment-details-invoice-subtitle m-0">PTS-874562</p>
                            </Col>
                            <Col sm={4} className="col-6">
                                <p className="appointment-details-invoice-title m-0 mb-1">Patient Name</p>
                                <p className="appointment-details-invoice-subtitle m-0">Meera Iyer</p>
                            </Col>
                            <Col sm={4} className="col-6">
                                <p className="appointment-details-invoice-title m-0 mb-1">Phone No</p>
                                <p className="appointment-details-invoice-subtitle m-0">+91 9876543210</p>
                            </Col>
                            <Col sm={4} className="col-6">
                                <p className="appointment-details-invoice-title m-0 mb-1">Date</p>
                                <p className="appointment-details-invoice-subtitle m-0">7 Jul, 2024</p>
                            </Col>
                            <Col sm={4} className="col-6">
                                <p className="appointment-details-invoice-title m-0 mb-1">Time</p>
                                <p className="appointment-details-invoice-subtitle m-0">10:00 AM</p>
                            </Col>
                            <Col sm={4} className="col-6">
                                <p className="appointment-details-invoice-title m-0 mb-1">Payment Method</p>
                                <p className="appointment-details-invoice-subtitle m-0">Online</p>
                            </Col>
                        </Row>
                    </ContentContainer>
                </Col>
