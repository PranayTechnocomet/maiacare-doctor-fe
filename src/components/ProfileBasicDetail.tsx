            ...
            content: (
                <>
                    <div className="text-center">
                        ...
                        <Button onClick={() => setShowPhisicalAssessment(true)} variant="outline" disabled={false} >
                            <IoAdd /> Add Physical Assessment
                        </Button>
                    </div>
                    <div>
                        <Accordion defaultActiveKey="0">
                            {physicalAssessmentData.map((item, index) => {
                                return (
                                    <Accordion.Item eventKey={index.toString()} className='phisical-assessment-accordion-item mb-3'>
        ...
        },
        {
            ...
            content: (
                <div className="text-center">
                    ...
                    <Button onClick={() => setShowFertilityAssessment(true)} variant="outline" disabled={false} >
                        <IoAdd /> Add Physical Assessment
                    </Button>
                </div>
            ),
                                ...
                                <div className='patient-journey-box ms-5 mb-3 ' key={item.id}>
                                    ...
                                    <div className="position-absolute start-0 patient-journey-dot">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
                                            ...
                                            <defs>
                                                <filter id="filter0_d_2106_90109" x="0.164062" y="0.339844" width="28" height="28" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
